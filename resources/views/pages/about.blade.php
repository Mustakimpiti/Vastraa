...
@section('title', 'About Us - Clothing Shop')

@section('content')
<!--== Start Page Title Area ==-->
<section class="page-title-area bg-img bg-overlay-black2-5 bg-parallax" data-speed="1.1" data-bg-img="{{ asset('assets/img/photos/bg-page2.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
            ...
            <div class="col-md-6 col-lg-7">
                <div class="divider-about-thumb">
                    <div class="video-content">
                        <div class="thumb">
                            <img src="{{ asset('assets/img/photos/video2.jpg') }}" alt="Moren-Image">
                ...
                <div class="swiper-container brand-logo-slider-container">
                    <div class="swiper-wrapper brand-logo-slider">
                        <div class="swiper-slide brand-logo-item">
                            <a href="#/"><img src="{{ asset('assets/img/brand-logo/1.png') }}" alt="Brand-Logo"></a>
                        </div>
                        <div class="swiper-slide brand-logo-item">
                            <a href="#/"><img src="{{ asset('assets/img/brand-logo/2.png') }}" alt="Brand-Logo"></a>
                        </div>
                        <div class="swiper-slide brand-logo-item">
                            <a href="#/"><img src="{{ asset('assets/img/brand-logo/3.png') }}" alt="Brand-Logo"></a>
                        </div>
                        <div class="swiper-slide brand-logo-item">
                            <a href="#/"><img src="{{ asset('assets/img/brand-logo/4.png') }}" alt="Brand-Logo"></a>
                        </div>
                        <div class="swiper-slide brand-logo-item">
                            <a href="#/"><img src="{{ asset('assets/img/brand-logo/5.png') }}" alt="Brand-Logo"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row team-members-style2 row-gutter-60">
            <div class="col-sm-6 col-md-4">
                <div class="team-member">
                    <div class="thumb">
                        <img src="{{ asset('assets/img/team/1.jpg') }}" alt="Broly-HasTech">
                    </div>
                    <div class="content">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="team-member mt-xs-30">
                    <div class="thumb">
                        <img src="{{ asset('assets/img/team/2.jpg') }}" alt="Broly-HasTech">
                    </div>
                    <div class="content">
                        <div class="member-info">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="team-member mt-sm-30">
                    <div class="thumb">
                        <img src="{{ asset('assets/img/team/3.jpg') }}" alt="Broly-HasTech">
                    </div>
                    <div class="content">
                        <div class="member-info">
                ...
                <div class="swiper-container post-slider-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="post-item">
                                <div class="thumb">
                                    <a href="{{ url('/blog-details') }}"><img src="{{ asset('assets/img/blog/s1.jpg') }}" alt="Moren-Image"></a>
                                </div>
                                <div class="content">
                                    <div class="post-meta">
                                        <img src="{{ asset('assets/img/icons/s1.jpg') }}" alt="Image">
                                        <a href="{{ url('/blog') }}">Agnes Wilson</a>
                                    </div>
                                    <div class="inner-content">
                                        <h4 class="title">
                                            <a href="{{ url('/blog-details') }}">Upcycling Brand Nereja</a>
                                        </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Diam risus semper varius vestibulum…</p>
                                    </div>
                                    <a href="{{ url('/blog-details') }}" class="btn-theme btn-border btn-black">Continue reading</a>
                                </div>
                            </div>
                            <!--== End Blog Post Item ==-->
                        </div>
                        <div class="swiper-slide">
                            ...
                            <div class="post-item">
                                <div class="thumb">
                                    <a href="{{ url('/blog-details') }}"><img src="{{ asset('assets/img/blog/s2.jpg') }}" alt="Moren-Image"></a>
                                </div>
                                <div class="content">
                                    <div class="post-meta">
                                        <img src="{{ asset('assets/img/icons/s1.jpg') }}" alt="Image">
                                        <a href="{{ url('/blog') }}">John Doe</a>
                                    </div>
                                    <div class="inner-content">
                                        <h4 class="title">
                                            <a href="{{ url('/blog-details') }}">Katie Holmes Revives</a>
                                        </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Diam risus semper varius vestibulum…</p>
                                    </div>
                                    <a href="{{ url('/blog-details') }}" class="btn-theme btn-border btn-black">Continue reading</a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="post-item">
                                <div class="thumb">
                                    <a href="{{ url('/blog-details') }}"><img src="{{ asset('assets/img/blog/s3.jpg') }}" alt="Moren-Image"></a>
                                </div>
                                <div class="content">
                                    <div class="post-meta">
                                        <img src="{{ asset('assets/img/icons/s1.jpg') }}" alt="Image">
                                    ...
                                    <div class="inner-content">
                                        <h4 class="title">
                                            <a href="{{ url('/blog-details') }}">Honey, They Shrunk</a>
                                        </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Diam risus semper varius vestibulum…</p>
                                    </div>
                                    <a href="{{ url('/blog-details') }}" class="btn-theme btn-border btn-black">Continue reading</a>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="post-item">
                                <div class="thumb">
                                    <a href="{{ url('/blog-details') }}"><img src="{{ asset('assets/img/blog/s4.jpg') }}" alt="Moren-Image"></a>
                                </div>
                                <div class="content">
                                    <div class="post-meta">
                                        <img src="{{ asset('assets/img/icons/s1.jpg') }}" alt="Image">
                                    ...
                                    <div class="inner-content">
                                        <h4 class="title">
                                            <a href="{{ url('/blog-details') }}">Consider the Backless</a>
                                        </h4>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Diam risus semper varius vestibulum…</p>
                                    </div>
                                    <a href="{{ url('/blog-details') }}" class="btn-theme btn-border btn-black">Continue reading</a>
...
<!--== Start Contact Area ==-->
<section class="contact-area contact-about-area bg-img" data-bg-img="{{ asset('assets/img/about/2.jpg') }}">
            ...
            <div class="col-lg-6">
                <div class="col-right">
                    <div class="contact-form">
                        <form class="contact-form-wrapper" id="contact-form" action="{{ url('/contact-submit') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
